...
def Update():
    ...
    pricedata['ema'] = ema(pricedata['bidclose'], 8)
    pricedata['ema_slow'] = ema(pricedata['bidclose'], 15)
    ...
    # TRADING LOGIC
    if crossesOver(iFastSMA, iSlowSMA):#if  math.isnan(pricedata['min'].iloc[-1]) != True:#  \
