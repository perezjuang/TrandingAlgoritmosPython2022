...
def Update():
    ...
    pricedata['ema'] = ema(pricedata['bidclose'], 5)
    ...
    if crossesOver(iFastSMA, iSlowSMA):
        if pricedata['ema_slow'][len(pricedata) - 1]  > pricedata['ema_res1'][len(pricedata) - 1] > pricedata['ema_res2'][len(pricedata) - 1]:
            print("	  BUY SIGNAL! ") 
            ...
            print("EMAS no estan en posicion " + str(pricedata['ema_slow'][len(pricedata) - 1]) + " > " + str(pricedata['ema_res1'][len(pricedata) - 1]) + " > " + str(pricedata['ema_res2'][len(pricedata) - 1]) + " - " ) 
