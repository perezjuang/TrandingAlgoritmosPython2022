...
class ZRobotOOP_PICOSMACD(threading.Thread):
    # instance attributes
    def __init__(self, symbol, timeframe, con):
        threading.Thread.__init__(self)
        self.symbol = symbol
        # Available periods : 'm1', 'm5', 'm15', 'm30', 'H1', 'H2', 'H3', 'H4', 'H6', 'H8','D1', 'W1', or 'M1'.
        self.timeframe = timeframe

        self.fast_sma_periods = int(10)
        self.slow_sma_periods = int(30)
        ...
        self.macdsub = float(-0.0003)
        self.macduper = float(0.0003)

        # Global Variables
        self.pricedata = None
        self.numberofcandles = int(100)
...
if __name__ == "__main__":
    ...
    a = ZRobotOOP_PICOSMACD("EUR/JPY", "m1",con)
    a.Prepare()
    a.StrategyStart()
