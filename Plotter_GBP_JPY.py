...
class SubplotAnimation(animation.TimedAnimation):
    def __init__(self):
        ...
        self.buyClose, = self.axBase.plot([], [], '.', color='red')
        ...
        self.axBase.add_line(self.sellClose)
        self.axBase.add_line(self.buyOpen)
        self.axBase.add_line(self.buyClose)
